; Note: Put your custom routine/data macros, references to them, and defines in this file from within the MPAINT_InsertIntegratedPatches and MPAINT_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro MPAINT_InsertIntegratedPatches()
...
macro MPAINT_ApplyPatchesPostAssembly()
